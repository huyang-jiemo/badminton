...
(
  ...
  member_num   int             null
  comment '报名人数',
  member_sex   int default '1' null
  comment '性别',
  member_phone bigint          null
  comment '联系电话',
  status       int default '1' null
  comment '状态'
)
...
(
  ...
  comment '俱乐部地点',
  club_qq_group varchar(100)    null
  comment '俱乐部QQ群',
  status        int default '1' null
  comment '状态'
)
...
(
  ...
  comment '比赛名称',
  match_address varchar(255)    null
  comment '比赛场地',
  men_single    int default '1' null
  comment '男单',
  women_single  int default '1' null
  comment '女单',
  men_double    int default '1' null
  comment '男双',
  women_double  int default '1' null
  comment '女双',
  mix_double    int default '1' null
  comment '混双',
  limit_member  int default '0' null
  comment '限报人数',
  match_memo    varchar(1000)   null
  comment '比赛说明',
  start_time    varchar(30)     null
  comment '比赛开始时间',
  end_time      varchar(30)     null
...
(
  ...
  comment '电话',
  match_type int         null
  comment '类型：1-男单；2-女单；3-男双；4-女双；5-混双',
...
(
  ...
  match_type     int             null
  comment '类型：1-男单；2-女单；3-男双；4-女双；5-混双',
  match_judge    varchar(100)    null
  comment '裁判',
  against_member varchar(100)    null
  comment '对阵方',
  against_sort   int             null
  comment '比赛排序',
  winner         varchar(10)     null
  comment '获胜方',
  match_point1   varchar(50)     null
  comment '第一场',
  match_point2   varchar(50)     null
  comment '第二场',
  match_point3   varchar(50)     null
  comment '第三场',
  status         int default '1' null
  comment '状态'
)
